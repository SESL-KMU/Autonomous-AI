...
MODEL                = sensor
MODULES              = rt_nonfinite.c sensor_data.c 
MAKEFILE             = sensor.mk
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);E:\test_sssss\sensor_grt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);E:\test_sssss
MATLAB_INCLUDES = $(MATLAB_INCLUDES);E:\tset_NI_Wheelsensor_sssss
...
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\XPCBLO~1}.c.obj :
	@echo ### Compiling $<
	$(CC) $(CFLAGS) $<
...
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\XPCBLO~1}.cpp.obj :
	@echo ### Compiling $<
	$(CC) $(CPPFLAGS) $<
