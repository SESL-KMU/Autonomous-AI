...
class GameState:
        ...
        def frame_step(self, p1_input_actions, p2_input_actions= None):
                """
...
def main(argv):
        ...
        while True:
                ...
                a1 = keys[pygame.K_LEFT]
                a2 = 0 if a1 else keys[pygame.K_RIGHT]
                a0 = 1 if not a1 and not a2 else 0

                p2 = [a0, a1, a2]

                image_data, reward = game_state.frame_step(p1, p2)#[a0, a1, a2])
