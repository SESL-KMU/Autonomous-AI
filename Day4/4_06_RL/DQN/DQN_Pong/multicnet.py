...
class MultilayerConvolutionalNetwork:
    ...
    """
    def __init__(self, graph, input_width, input_height, nimages, nchannels):
    ...
    def build_network(self):
        ...
        readout_action = tf.reduce_sum(readout*self.a, reduction_indices=1)
    ...
    def attempt_restore(self, directory, filename=None):
        """
    ...
    def readout_act(self, stack):
        ...
        return self.y_conv.eval(feed_dict = {self.input_image: stack}, session=self.session)
