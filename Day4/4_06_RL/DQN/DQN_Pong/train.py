...
def main(args):
    ...
    model_path = 'network-'+str(args.model) if args.model is not -1 else None
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        dest='train', action='store_true', default=True)
    parser.add_argument(
        '-c', '--clear',
    ...
    parser.add_argument(
        ...
        help='clears the folders where the state of the agent is saves. '
             'NOTE: use this to retrain the agent from scratch',
        dest='model', type=int, default=model_num)

    parser.add_argument(
        '-p', '--player',
        help='clears the folders where the state of the agent is saves. '
             'NOTE: use this to retrain the agent from scratch',
        dest='players', type=int, default=1)
