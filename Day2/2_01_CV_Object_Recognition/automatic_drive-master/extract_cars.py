...
# ③ 计算颜色直方图 hist 特征 컬러 히스토그램의 hist 기능 계산
...
# ⑤ 返回单张图片的 1 行特征样本 단일 사진의 1 행 특징 샘플 반환
...
# Main Code
# 读取训练图片的位置与文件名 훈련 이미지의 위치와 파일 이름을 읽습니다.
...
ShowImage('image1', drawn_image, 1)
