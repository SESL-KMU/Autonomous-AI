...
# cap = cv2.VideoCapture('D:/Control/자율주행 교재/자이카.mp4')
...
def weighted_img(img, initial_img, aa=0.8, bb=1., cc=0.):
...
def detect_lanes_img(img):
    ...
    # Set ROI
    vertices = np.array(
        [[(0, height), (width / 2 - 130, height * 2 / 5 + 0), (width / 2 + 130, height * 2 / 5 + 0), (width - 0, height)]],
        # [[(0, height), (width / 2 - 160, height / 2 + 0), (width / 2 + 160, height / 2 + 0), (width - 0, height)]],
#        [[(0, height), (width / 2 - 140, height / 2 + 100), (width / 2 + 140, height / 2 + 100), (width - 0, height)]],
        dtype=np.int32)
    ...
    vertices2 = np.array(
        [[(2, height), (width / 2 - 128, height * 2 / 5 + 2), (width / 2 + 128, height * 2 / 5 + 2), (width - 2, height)]],
        # [[(2, height), (width / 2 - 158, height / 2 + 2), (width / 2 + 158, height / 2 + 2), (width - 2, height)]],
#        [[(2, height), (width / 2 - 138, height / 2 + 102), (width / 2 + 138, height / 2 + 102), (width - 2, height)]],
    ...
    line_arr = hough_lines(canny_img, 1, 1 * np.pi / 180, 30, 10, 30)
